...
#ifndef ALGLIB_IPOPT_TESTPROBLEM_HPP
#define ALGLIB_IPOPT_TESTPROBLEM_HPP
...
class TestProblem: public TNLP {
public:
    TestProblem(const real_1d_array& expectReturn,
